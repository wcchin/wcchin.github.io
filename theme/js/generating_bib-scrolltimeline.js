...
function activating() {
  let li = $(this).parent();
  let index = li.index();
  let milestones = $(".timeline__section .milestone");
...
function load_bibtex(fp) {
  ...
  //console.log(yr);
  var yrlist = document.getElementById('timeline_ul');
  var bibcontent = document.getElementById('timeline_wrapper');
  ...
  xhr.onreadystatechange = function() {
    if (xhr.readyState == 4 && xhr.status == 200) {
      ...
      for (let i=0;i<years.length;i++) {
        ...
        yearSpan.innerHTML = yr;
        yearSpan.onclick = activating;
        var li = document.createElement('li');
        li.appendChild(yearSpan);
        //li.setAttribute("id", "element4"); // added line
        yrlist.appendChild(li);
        //yrlist.append('<li><span>'+yr+'</span></li>');
        bibcontent.innerHTML += '<div class="block" id="bibtex_'+yr+'"><h3 class="milestone">'+yr+'</h3></div>';
      }
